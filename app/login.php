...
if (isset($_GET['username'])) {
  ...
  if($_GET['submitBtn'] == "Register") {
    $countquery = "SELECT COUNT(*) as total FROM carpool.carpool.users";
    $countresult = pg_query($query) or die('Query failed: ' . pg_last_error());
    $rowcount = pg_fetch_row($countresult);
